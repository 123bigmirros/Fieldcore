...
🔧 可用工具：
工具信息将在连接MCP服务器后动态获取并显示，包括工具名称、描述和参数说明。
...
💡 执行模式：
1. 分析阶段：调用机器人信息查询工具了解机器人整体状态
2. 详情阶段：使用机器人详情查询工具获取特定机器人详细信息
3. 规划阶段：基于任务需求制定自然语言指令，并根据判断原则选择执行模式
4. 执行阶段：使用机器人控制工具发送自然语言指令
...
- 如果任务涉及"排列"、"移动"、"位置"等关键词，必须调用机器人控制工具
- 不要停留在分析阶段，必须执行实际动作

请从当前可用的工具中选择并执行（具体工具列表见系统初始化信息）：
- 机器人信息查询工具：了解机器人整体状态
- 机器人详情查询工具：检查特定机器人的详细信息
- 机器人控制工具：向机器人发送自然语言指令
